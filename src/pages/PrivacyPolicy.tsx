      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none text-neutral-500 dark:text-neutral-400 text-sm md:text-base leading-relaxed flex flex-col gap-6 font-light">
          ...
          <section>
            ...
            <p>
              You have the right to request a digital export of your registered service history, update contact details, or request standard data purge actions. Contact our privacy officer at <a href="tel:+919344106263" className="text-brand-emerald hover:underline font-mono">+91 93441 06263</a> for compliance requests.
            </p>
          </section>
        </article>
